...
Semantic HTML adds meaning to your code, making easier for you or others to read it.
2. Name two big differences between ```display: block;``` and ```display: inline;```.
With display:block; the top and bottom margin / paddings are respected, where as in display:inline; they are not.
3. What are the 4 areas of the box model?
Content, Padding, Border, Margin
4. While using flexbox, what axis does the following property work on: ```align-items: center```?
Cross Axis
5. Explain why git is valuable to a team of developers.
It is a fast and effective way to update and upload code and allows ease of cooperation between developers to keep the team on the same page.
